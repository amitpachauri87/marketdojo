<?php /*Template Name: Innovation Product*/ ?>
<?php get_header(); ?>
    ...
    <div class="body_content">
        ...
        <div class="body_section product_tree_main_box on_demand">
            ...
            <div class="container">
                <div class="newCircleWrap onDemand secondCircleWrap">
                    <div class="circleTabMenu">
                        <ul>
                            <?php
                                global $q_config;
                                $language = $q_config['language'];
                                $taxonomy='innovation-product-cat';
                                $term_id=67;
                    ...
                    <div class="circleTabWrap">
                        ...
                        <div class="circlePanCont">
                            ...
                            <div class="circleFirst">
                                <ul>
                            <?php }elseif($i==2){ ?>
                            <div class="circleLast splSecondLast">
                                <ul>
                            <?php }elseif($i==5){ ?>
            ...
            <div class="container">
                <div class="row d-flex align-items-center">
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <figure class="logo"><a href="<?php bloginfo('url'); ?>"><img src="<?php echo $flatsome_opt['site_logo_inno']; ?>" alt="logo"></a></figure>
                    </div>
                    <div class="col-md-9 col-sm-8 col-xs-12">
                        <div class="menu">
                           <a href="javascript:void(0);" class="menuClose2"><i class="fa fa-times-circle" aria-hidden="true"></i></a>
                            <?php wp_nav_menu( array( 'container' => '', 'theme_location' => 'innovationdojo_menu', 'menu_class' => '') ); ?>
                        </div>
