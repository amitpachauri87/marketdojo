<?php /* Template Name: Product Quick Quotes */ ?>
<?php get_header(); ?>     
<!-- body content start -->
...
<?php
            $i=0;
            $q=0;
            $class_name = array("0"=>"left", "1"=>"center", "2"=>"right","3"=>"left","4"=>"first", "5"=>"second");
            ...
            ?>
                ...
                <div class="each_round_holder <?php echo $class_name[$j]; if($i==1){echo " active";} ?>">
...
if($i==1){ 
        $div_class="each_round_holder left active";
        $span_class="icon_holder quick_quote";
    ?>
            <div class="three_sub_child_box">
<?php
}
elseif($i==2){ 
    $div_class="each_round_holder center";
    $span_class="icon_holder on_demand";
}
elseif($i==3){ 
    $div_class="each_round_holder right";
    $span_class="icon_holder enterprise_cr";
}
elseif($i==4){
    $div_class="each_round_holder left";
    $span_class="icon_holder questionere";
?>
        </div>
            <div class="circle_line line_second">
<?php
...
if($i==5){ 
    $div_class="each_round_holder first";
    $span_class="icon_holder rfq";
?>
            </div>
            <div class="circle_line third_line">
<?php }
elseif($i==6){ 
    $div_class="each_round_holder second";
    $span_class="icon_holder reporting_pr";
}
elseif($i==7){ ?>
            </div>
<?php }
                    ...
                    <div class="col-md-9 col-sm-8 col-xs-12">
                        <div class="menu">
                           <a href="javascript:void(0);" class="menuClose2"><i class="fa fa-times-circle" aria-hidden="true"></i></a>
                            <?php wp_nav_menu( array( 'container' => '', 'theme_location' => 'product_quick_quotes', 'menu_class' => '') ); ?>
                        </div>
