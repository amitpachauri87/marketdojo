...
<div class="body_content">
    ...
    <section class="pricing_page_sec others_pricing_page_sec">
        <div class="container">
            ...
            <?php
                $query = new WP_Query( array( 'p' => 3153  ,'post_type'=>'marketdojopricingbox') );
            ...
            <?php
                $query = new WP_Query( array( 'p' => 3170  ,'post_type'=>'marketdojopricingbox') );
                if ( $query->have_posts() ) : while ( $query->have_posts() ): $query->the_post();
            ?>
                        ...
                        <div class="billing_details">
                            <div class="content">
                                ...
                                <span class="user_price price">
                                    <i class="fa fa-gbp"></i><i class="fa fa-euro" style="display: none;"></i><i class="fa fa-usd" style="display: none;"></i><span id="price-monthly"><?php the_field('default_price'); ?></span> <em><?php the_field('pricing_section_text'); ?></em>
                                </span>
                                <?php /*<span class="price"><?php the_field('pricing_section_text'); ?></span>*/ ?>
                                <span class="billDetails">
                                    <?php the_field('sub_heading'); ?>
                                </span>
                            </div>
