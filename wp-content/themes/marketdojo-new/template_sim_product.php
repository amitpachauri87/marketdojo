...
<?php get_header(); ?>
    ...
    <div class="body_content">
        ...
        <div class="body_section product_tree_main_box on_demand sim-dojo invited_cat_back">
            ...
            <div class="container">
                <div class="newCircleWrap onDemand quickQuotes">
                   	<div class="circleTabMenu">
                        <ul>
                            <?php
                                global $q_config;
                                $language = $q_config['language'];
                                $taxonomy='sim-product-cat';
                                $term_id=68;
                            ...
                            ?>
                            <li class="circleBtn <?php echo $term->slug; ?>" data-heading="<?php echo $term->name; ?>" data-content="<?php echo $term_description; ?>">
                                <?php
                                    if($term_color){
                                ?>
                                <style>
                                    .<?php echo $term->slug; ?>:hover .newCircle {
                                        box-shadow: 0px 0px 35px <?php echo $term_color; ?> !important;
                                        cursor: pointer;
                                    }
                                    .<?php echo $term->slug; ?> .newCircle {
                                        border-color: <?php echo $term_color; ?> !important;
                                        background: <?php echo $term_color; ?> !important;
                                    }
                                    .product_tree_main_box.invited_cat_back {
                                        background-color: <?php echo $term_bg_color; ?> !important;
                                    }
                                </style>
                                <?php
                                    }
                            ...
                            <li class="circleBtn <?php echo $term->slug; ?>" data-heading="<?php echo $term->name; ?>" data-content="<?php echo $term_description; ?>">
                                ...
                                <style>
                                    ...
                                    .product_tree_main_box.supplier_portal_cat_back {
                                        background-color: <?php echo $term_bg_color; ?> !important;
                                    }
                                </style>
                                <?php
                    ...
                    <div class="circleTabWrap">
                        ...
                        <div class="circlePanCont invitedPortal">
                            <?php
                                $i=0;$j=0;
                                $args = array(
                                    'post_type' => 'sim-product',
                                    'posts_per_page' => 6,
                                    'tax_query' => array(
                                        array(
                                            'taxonomy' => 'sim-product-cat',
                            ...
                            <?php if($i==1){ ?>
                            <div class="circleFirst activeFirst">
                                <ul>
                            <?php }elseif($i==2){ ?>
                            <div class="circleLast splLast">
                                <ul>
                            <?php }elseif($i==5){ ?>
                            <div class="circleLast splSecondLast invitedLast">
                                <ul>
                            <?php } ?>
                        ...
                        <div class="circlePanCont supplierPortal">
                            <?php
                                $i=0;$j=0;
                                $args = array(
                                    'post_type' => 'sim-product',
                            ...
                            <?php if($i==1){ ?>
                            <div class="circleFirst activeLast">
                                <ul>
                            <?php }elseif($i==2){ ?>
                            <div class="circleLast splLast">
                                <ul>
                            <?php }elseif($i==6){ ?>
                            <div class="circleLast splSecondLast supplierLast">
                                <ul>
                            <?php } ?>
                                    <li data-prod_id="<?php echo $post->ID; ?>" class="<?php echo $post->post_name; ?>">
                                        <style>
                    ...
                    <div class="col-md-9 col-sm-8 col-xs-12">
                        <div class="menu">
                           <a href="javascript:void(0);" class="menuClose2"><i class="fa fa-times-circle" aria-hidden="true"></i></a>
                            <?php wp_nav_menu( array( 'container' => '', 'theme_location' => 'simdojo_menu', 'menu_class' => '') ); ?>
                        </div>
