<?php /* Template Name: Product On Demand */ ?>
<?php get_header(); ?>    
<!-- body content start -->
    <div class="body_content">
        
        <div class="body_section product_tree_main_box on_demand">
...
<?php
            $i=0;
            $q=0;
            $class_name = array("0"=>"left", "1"=>"center", "2"=>"right","3"=>"center","4"=>"first", "5"=>"second", "6"=>"third");
            ...
            ?>
                ...
                <div class="each_round_holder <?php echo $class_name[$j]; if($i==2){echo " active";} ?>">
...
<?php
  /*  if( have_rows('section_1_sourcing_list') ):
        $i=1;
    while ( have_rows('section_1_sourcing_list') ) : the_row();
    if($i==1){ ?>
        <div class="three_sub_child_box">
            <div class="each_round_holder left">
                    <span class="icon_holder quick_quote">
                        <?php $image = get_sub_field('sourcing_list_image'); ?>
                        <img src="<?= $image['url'] ?>" alt="<?= $image['alt'] ?>">
                    </span>
                    <span class="title"><?php the_sub_field('sourcing_list_title'); ?></span>
                </div>

<?php
}
elseif($i==2){ ?>
                <div class="each_round_holder center active">
                    <span class="icon_holder on_demand">
                        <?php $image = get_sub_field('sourcing_list_image'); ?>
                        <img src="<?= $image['url'] ?>" alt="<?= $image['alt'] ?>">
                    </span>
                    <span class="title"><?php the_sub_field('sourcing_list_title'); ?></span>
...
elseif($i==3){ ?>
                ...
                <div class="each_round_holder right">
                    <span class="icon_holder enterprise_cr">
                       <?php $image = get_sub_field('sourcing_list_image'); ?>
                        <img src="<?= $image['url'] ?>" alt="<?= $image['alt'] ?>">
                    </span>
                    <span class="title"><?php the_sub_field('sourcing_list_title'); ?></span>
...
?>
            ...
            <div class="circle_line line_second">
                ...
                <div class="each_round_holder center">
                    <span class="icon_holder questionere">
                        <?php $image = get_sub_field('sourcing_list_image'); ?>
                        <img src="<?= $image['url'] ?>" alt="<?= $image['alt'] ?>">
                    </span>
                    <span class="title"><?php the_sub_field('sourcing_list_title'); ?></span>
...
if($i==5){ ?>
            <div class="circle_line third_line">
                ...
                <div class="each_round_holder first">
                    <span class="icon_holder rfq">
                        <?php $image = get_sub_field('sourcing_list_image'); ?>
                        <img src="<?= $image['url'] ?>" alt="<?= $image['alt'] ?>">
                    </span>
                    <span class="title"><?php the_sub_field('sourcing_list_title'); ?></span>
...
elseif($i==6){ ?>
                <div class="each_round_holder second">
                    <span class="icon_holder auction">
                        <?php $image = get_sub_field('sourcing_list_image'); ?>
                        <img src="<?= $image['url'] ?>" alt="<?= $image['alt'] ?>">
                    </span>
                    <span class="title"><?php the_sub_field('sourcing_list_title'); ?></span>
...
<?php }
elseif($i==7){ ?>
                <div class="each_round_holder third">
                    <span class="icon_holder reporting_pr">
                        <?php $image = get_sub_field('sourcing_list_image'); ?>
                        <img src="<?= $image['url'] ?>" alt="<?= $image['alt'] ?>">
                    </span>
                    <span class="title"><?php the_sub_field('sourcing_list_title'); ?></span>
                    ...
                    <div class="col-md-9 col-sm-8 col-xs-12">
                        <div class="menu">
                           <a href="javascript:void(0);" class="menuClose2"><i class="fa fa-times-circle" aria-hidden="true"></i></a>
                            <?php wp_nav_menu( array( 'container' => '', 'theme_location' => 'product_on_demand', 'menu_class' => '') ); ?>
                        </div>
