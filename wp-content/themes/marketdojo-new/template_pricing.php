...
<div class="body_content">
    ...
    <section class="pricing_page_sec">
        <div class="container">
            ...
            <div class="plan_box_holder pricing_table_main_holder clear">
            <?php
                $query = new WP_Query( array( 'p' => 2875 ,'post_type'=>'marketdojopricingbox') );
                if ( $query->have_posts() ) : while ( $query->have_posts() ): $query->the_post();
            ?>
                <div class="each_plan_box each_table green">
                    <h2><?php the_title(); ?></h2>
                    <div class="billing_details fees">
                        <div class="content cell">
                            ...
                            <div class="user_stat users">
                                ...
                                <select name="" id="price-monthly-selectnew">
                                <?php
                            ...
                            <span class="price user_price">
                                <i class="fa fa-gbp"></i><i class="fa fa-euro" style="display: none;"></i><i class="fa fa-usd" style="display: none;"></i><span id="price-monthlynew"><?php the_field('default_price'); ?></span>/<em><?php the_field('default_duration'); ?></em>
                            </span>
            ...
            <?php
                ...
                if ( $query->have_posts() ) : while ( $query->have_posts() ): $query->the_post();
            ?>
                <div class="each_plan_box each_table red">
                    <h2><?php the_title(); ?></h2>
            ...
            <?php
                $query = new WP_Query( array( 'p' => 2877  ,'post_type'=>'marketdojopricingbox') );
                if ( $query->have_posts() ) : while ( $query->have_posts() ): $query->the_post();
            ?>
                <div class="each_table yellow">
                    <h2><?php the_title(); ?></h2>
                    ...
                    <tbody>
                        ...
                        <tr class="heading">
                            ...
                            <td>
								...
								?>
								<a data-fancybox href="#post-<?php the_field('section_3_button_1_form'); ?>" class="btn_table green"><?php the_field('section_3_button_1_text'); ?></a>
								<?php }else{ ?>
								<a href="<?php the_field('section_3_button_1_link'); ?>" class="btn_table green"><?php the_field('section_3_button_1_text'); ?></a>
								<?php } ?>
							</td>
                            <td>
								<?php
								...
								?>
								<a data-fancybox href="#post-<?php the_field('section_3_button_2_form'); ?>" class="btn_table red"><?php the_field('section_3_button_2_text'); ?></a>
								<?php }else{ ?>
								<a href="<?php the_field('section_3_button_2_link'); ?>" class="btn_table red"><?php the_field('section_3_button_2_text'); ?></a>
								<?php } ?>
							</td>
                            <td>
								<?php
								$section_3_button_3_popup = get_field('section_3_button_3_popup');
								if( $section_3_button_3_popup && in_array('yes', $section_3_button_3_popup) ){
								?>
								<a data-fancybox href="#post-<?php the_field('section_3_button_3_form'); ?>" class="btn_table yellow"><?php the_field('section_3_button_3_text'); ?></a>
								<?php }else{ ?>
								<a href="<?php the_field('section_3_button_3_link'); ?>" class="btn_table yellow"><?php the_field('section_3_button_3_text'); ?></a>
								<?php } ?>
							</td>
                        </tr>
                    </tbody>
