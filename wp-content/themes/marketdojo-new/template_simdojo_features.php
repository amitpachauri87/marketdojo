<?php /*Template Name: Simdojo Features*/ ?>
<?php get_header(); ?>    
    <!-- body content start -->
        ...
        <section class="body_section features_sec">
            <div class="container">
                ...
                <div class="resource_box_holder">
                    ...
                    <?php 
                    $pstpage=8;
                    $loop = new WP_Query( array( 'post_type' => 'simdojo', 'posts_per_page' => $pstpage ) ); 
                ...
                <?php 
                $alllisting = new WP_Query( array( 'post_type' => 'simdojo', 'posts_per_page' => -1 ) );
