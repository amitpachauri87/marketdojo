                        ...
                        <div class="left_part">
                           ...
                           <?php $left_image = get_field('left_image'); 
                            ...
                            <?php 
								...
								$section_2_button_1_download_type=get_field('section_2_button_1_download_type');
                            	if($section_2_button_1_link!=""){ 
							?>
                                <a href="<?php echo $section_2_button_1_link; ?>" class="btn fill_btn" <?php if($section_2_button_1_download_type){ ?>download<?php } ?>><?php echo $section_2_button_1_text; ?></a>
                            <?php } 
