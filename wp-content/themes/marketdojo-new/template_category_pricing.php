<?php /* Template Name: Category Pricing */ ?>
<?php get_header(); ?>
<!-- cleint Sec Start -->
...
<div class="body_content">
    ...
    <section class="pricing_page_sec others_pricing_page_sec">
        <div class="container">
            ...
            <?php
                $query = new WP_Query( array( 'p' => 3012  ,'post_type'=>'marketdojopricingbox') );
            ...
            <?php
                $query = new WP_Query( array( 'p' => 3013  ,'post_type'=>'marketdojopricingbox') );
                if ( $query->have_posts() ) : while ( $query->have_posts() ): $query->the_post();
            ?>
